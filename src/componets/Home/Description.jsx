    ...
    <div className="flex-col h-auto p-5 text-sm flex gap-7 border-t-[1px] border-neutral-700">
      <section className="flex flex-col gap-2 text-xs md:text-sm">
        ...
        <p className="leading-6 opacity-75 ">
          ...
          shopping experience a breeze. With Swiftcart, you can buy and sell a
      ...
      <section className="text-xs md:text-sm">
        ...
        <p className="leading-6 opacity-75">
          ...
          Our intuitive website and user-friendly app allow you to browse
      ...
      <section className="text-xs md:text-sm">
        ...
        <p className="leading-6 opacity-75">
          ...
          ratings from other customers, and make informed decisions. Our
      ...
      <section className="text-xs md:text-sm">
        ...
        <p className="leading-6 opacity-75">
          ...
          package every step of the way, allowing you to stay informed and
